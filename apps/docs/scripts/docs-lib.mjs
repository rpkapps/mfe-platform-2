...
src/platform.d.ts           declare module "@platform/react" { interface Register { env; featureFlags } }
...
Testing (@platform/react/testing): createTestBridge({ mfeId, user, permissionGroups, env }), renderMfe(definition, { bridge, path }) -> { container, navigate, location, dispose }; PlatformTestProvider for hooks
