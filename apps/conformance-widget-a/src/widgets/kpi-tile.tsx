...
export function KpiTile({ label, value, unit }: { label: string; value: number; unit?: string }) {
  ...
  useRegisterCommand({ id: "refresh-tile", label: `Refresh ${label}`, group: "Widgets", handler: () => setRefreshed((n) => n + 1) })
  return (
