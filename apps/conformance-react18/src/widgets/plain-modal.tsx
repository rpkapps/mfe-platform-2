 ...
 */
export function PlainModal({ title, onClose, testId, children }: { title: string; onClose: () => void; testId: string; children?: React.ReactNode }) {
  ...
  return createPortal(
    <div className="legacy-modal" role="presentation">
      <div role="dialog" aria-modal="true" aria-label={title} data-testid={testId} className="legacy-card w-72 bg-white">
